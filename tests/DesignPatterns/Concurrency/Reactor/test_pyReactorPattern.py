...
from pyPantry.DesignPatterns.Concurrency.Reactor.PyReactorPattern import PyReactorPattern
...
class PyReactorPatternTestCase(unittest.TestCase):
    ...
    def test_accept_event_handler(self, MockSelector):
        ...
        selector.register.assert_called_once_with(
            mock_conn, selectors.EVENT_READ | selectors.EVENT_WRITE,
    ...
    def test_read_event_handler(self, MockSelector):
        ...
        with patch('builtins.print') as mocked_print:
            ...
            self.assertIn(call("Echoing data to ('127.0.0.1', 12345)"), mocked_print.mock_calls)

        with patch('builtins.print') as mocked_print:
            mock_sock.recv.return_value = b""
            handler.handle_event(key, selectors.EVENT_READ)
            self.assertIn(call("Closing connection to ('127.0.0.1', 12345)"), mocked_print.mock_calls)
