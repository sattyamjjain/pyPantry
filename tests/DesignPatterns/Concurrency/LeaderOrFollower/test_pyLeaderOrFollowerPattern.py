...
from pyPantry.DesignPatterns.Concurrency.LeaderOrFollower.PyLeaderOrFollowerPattern import PyLeaderOrFollowerPattern
...
class PyLeaderFollowersPatternTestCase(unittest.TestCase):
    ...
    def test_accept_connection(self, MockSocket, MockSelector):
        ...
        mock_selector.register.assert_called_once_with(mock_conn, selectors.EVENT_READ, pattern.handle_connection)
