...
from pyPantry.DesignPatterns.Behavioral.Observer.PyObserverPattern import PyObserverPattern
...
class PyObserverPatternTestCase(unittest.TestCase):
    ...
    def test_observer_notification(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            ...
            self.assertIn("Alice received news: Breaking News: Observer Pattern in Action!", output)
            self.assertIn("Bob received news: Breaking News: Observer Pattern in Action!", output)
