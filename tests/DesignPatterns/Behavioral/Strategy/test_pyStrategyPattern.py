...
class PyStrategyPatternTestCase(unittest.TestCase):
    ...
    def test_credit_card_payment(self):
        ...
        credit_card_payment = PyStrategyPattern.CreditCardPayment("John Doe", "1234-5678-9876-5432", "123", "12/23")
    ...
    def test_paypal_payment(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            cart.checkout()
            output = fake_out.getvalue().strip()
            self.assertIn("Paid 14.48 using PayPal account john.doe@example.com", output)
    ...
    def test_bitcoin_payment(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            cart.checkout()
            output = fake_out.getvalue().strip()
            self.assertIn("Paid 14.48 using Bitcoin wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa", output)
