...
class PySpecificationPattern(PyDesignPatterns):
    ...
    class Specification(ABC):
        ...
        def __and__(self, other: 'PySpecificationPattern.Specification') -> 'PySpecificationPattern.Specification':
            return PySpecificationPattern.AndSpecification(self, other)

        def __or__(self, other: 'PySpecificationPattern.Specification') -> 'PySpecificationPattern.Specification':
    ...
    class ProductFilter:
        @staticmethod
        def filter(
                products: List['PySpecificationPattern.Product'], spec: 'PySpecificationPattern.Specification'
